...
! Add precipitation buckets between outputs for sub-hourly precip
      DATA IFILV(518),AVBL(518),IQ(518),IS(518),AVBLGRB2(518)      &
     &                      /1,'BUCKET1 TOTAL PRECIP',061,001,     &
     &                       'A_PCP1 ON surface'/
      DATA IFILV(519),AVBL(519),IQ(519),IS(519),AVBLGRB2(519)      &
     &                      /1,'BUCKET1 CONV PRECIP ',063,001,     &
     &                       'ACPCP1 ON surface'/
      DATA IFILV(520),AVBL(520),IQ(520),IS(520),AVBLGRB2(520)      &
     &                      /1,'BUCKET1 GRDSCALE PCP',062,001,     &
     &                       'NCPCP1 ON surface'/
      DATA IFILV(521),AVBL(521),IQ(521),IS(521),AVBLGRB2(521)      &
     &                      /1,'BUCKET1 SNOW  PRECIP',065,001,     &
     &                       'WEASD1 ON surface'/
      DATA IFILV(522),AVBL(522),IQ(522),IS(522),AVBLGRB2(522)      &
     &                      /1,'BUCKET1 GRAUP PRECIP',179,001,     &
     &                       'GRAUP1 ON surface'/
