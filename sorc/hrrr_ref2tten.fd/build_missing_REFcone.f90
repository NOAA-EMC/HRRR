SUBROUTINE build_missing_REFcone(nlon,nlat,nsig,krad_bot_in,ref_mos_3d,h_bk,pblh)
!
!  radar observation
!
!
...
!
  ...
  real(r_kind) :: newlvlAll_save(maxlvl)   ! vertical levels of reflectivity statistic profile(km)
  DATA newlvlAll_save/0.2, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, &
...
!
  season=1
  DO k=1,maxlvl
     newlvlAll(k)=newlvlAll_save(k)*1000.0_r_kind
  ENDDO
!
  DO j=2,nlat-1
    DO i=2,nlon-1
