...
!-------------  get grid info
  ...
  if(trim(rmse_var)=='TSK' .or. trim(rmse_var)=='SOILT1' .or.   &
     ...
     write(6,*) 'update_netcdf_mass: Safety check for variable ',trim(rmse_var)
...
!=========================================================
  ...
  enddo
  write(6,*) 'update_netcdf_mass_partial: Safety check for variable TSK'
  field3(:,:,1)=min(400.0,max(200.0,field3(:,:,1)))
  DO k=1,end_index(3)
    write(6,*)'Again max,min TSK=',maxval(field3(:,:,k)),minval(field3(:,:,k))
  enddo
  tsk=field3(:,:,1)
  ...
  field3(:,:,1)=min(400.0,max(200.0,field3(:,:,1)))
  DO k=1,end_index(3)
    write(6,*)'Again max,min TSK in BK=',maxval(field3(:,:,k)),minval(field3(:,:,k))
  enddo
...
!=========================================================
  ...
  enddo
  write(6,*) 'update_netcdf_mass_partial: Safety check for variable SOILT1'
  field3(:,:,1)=min(400.0,max(200.0,field3(:,:,1)))
  DO k=1,end_index(3)
    write(6,*)'Again max,min SOILT1=',maxval(field3(:,:,k)),minval(field3(:,:,k))
  enddo
  soilt1=field3(:,:,1)
  ...
  field3(:,:,1)=min(400.0,max(200.0,field3(:,:,1)))
  DO k=1,end_index(3)
    write(6,*)'Again max,min SOILT1 in BK=',maxval(field3(:,:,k)),minval(field3(:,:,k))
  enddo
...
!=========================================================
  ...
  enddo
  write(6,*) 'update_netcdf_mass_partial: Safety check for variable TSLB'
  field3=min(400.0,max(200.0,field3))
  tslb=field3
  DO k=1,end_index(3)
    write(6,*)'Again max,min TSLB=',maxval(field3(:,:,k)),minval(field3(:,:,k))
  enddo
  ...
  field3=min(400.0,max(200.0,field3))
  DO k=1,end_index(3)
    write(6,*)'Again max,min TSLB in BK=',maxval(field3(:,:,k)),minval(field3(:,:,k))
  enddo
! cycle snow grid point
...
!-------------  get grid info
  ...
  if(trim(rmse_var)=='TSK' .or. trim(rmse_var)=='SOILT1' .or.   &
     trim(rmse_var)=='TSLB') then
     write(6,*) 'update_netcdf_mass_sfc629: Safety check for variable ',trim(rmse_var)
     field3=min(400.0,max(200.0,field3))
     DO k=1,end_index(3)
         write(6,*)'Again max,min =',maxval(field3(:,:,k)),minval(field3(:,:,k))
     enddo
