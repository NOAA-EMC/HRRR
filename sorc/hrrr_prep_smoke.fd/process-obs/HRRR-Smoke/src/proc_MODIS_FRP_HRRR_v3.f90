...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  Time determination !!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  time_loop:  DO iloop=itime,ftime,time_step   ! time_step is fixed =15min
     ...
     OPEN(21,file=trim(input_modis),status='old', ACTION='read')      ! TRIM returns the argument with trailing blanks removed.
     READ(21,'(a80)') (cab(i),i=1,1)

     ! Create the name of the output file
     ! FORMAT >>  YYYYDDDHHMM_mod_3km.txt
     output = julday // chh // cmm // '_mod_HRRR.txt'
