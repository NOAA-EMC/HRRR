...
!-------------------------------------------------------------------
subroutine write_ctl(ng,iunit,wfln,ihour,iday,imon,iyear,nvert)
...
implicit none
character(*) :: wfln(2)
integer ng,ihour,iday,imon,iyear,nvert,iunit,iv,isp,nsrc

character*15 chdate,chstep,xchstep
character*3 cmo(12)
character*5 unitX
integer nfiles,imin,nvp,i
real zlev(nvert)
...
!write(iunit,2002) 'OPTIONS BIG_ENDIAN'
...
2007  format('vars ',i4)
2008  format(a10,i4,' 99    - EMISSION DATA : ',a20,'[',a8,']')
2009  format(a15,i4,' 99    - PLUME    DATA : ',a20,'[',a8,']')
2010  format(a10,i4,' 99    - VOLC. ERUPTION DATA : ',a20,'[',a8,']')
2011  format(a10,i4,' 99    - VOLC. DEGASS DATA : ',a20,'[',a8,']')
2055  format(60f7.0)
