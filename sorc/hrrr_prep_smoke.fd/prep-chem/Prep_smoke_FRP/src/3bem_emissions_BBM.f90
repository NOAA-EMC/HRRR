...
110  continue
  ...
  ! subroutine read_fre(iunit,n,qlon,qlat,qarea,qsize,qfrpw,qfre,qtime,ic,dqfrpw,qigbp,dqsize)
   ...
   subroutine read_fre(iunit,n,lon_frp,lat_frp,avg_frp,avg_fsize,std_frp,std_fsize,qfrpw,bbm,ic,dqfrpw,dqsize)
   ...
   ! 68.544411         70.374863          7.127995          0.001568   1.781999          0.000392          361945.344   1    32760.00        7.00
     ...
     integer,            intent(in)    :: iunit, &
                                          n
     integer,            intent(inout) :: ic
     real, dimension(n), intent(out)   :: lat, &
                                          lon, &
        !                                  qarea, &
                                          fsize, &
                                          frp, &
  ...
  !                                        qigbp, &
   ...
   ! 68.544411   70.374863      7.127995        0.001568         1.781999    0.000392      361945.344   1         32760.00      7.00
        ...
        do i=1,n
           ...
           read(iunit, *,  end=110) qlon(ic),qlat(ic), qfrpw(ic), qsize(ic), dqfrpw(ic), dqsize(ic), qfre, dummyInteger, dummyReal, dummyReal !qigbp (ic)
 
!Long               Lat           Average_FRP        Average_Fsize       Std_FRP          Std_Fsize         Skewness         FsizeTotal      BB              NOBS         IGBP
            write(*,100)"FRE", ic, qlon(ic),qlat(ic),qfrpw (ic),1.e+6*qsize(ic),qfre
