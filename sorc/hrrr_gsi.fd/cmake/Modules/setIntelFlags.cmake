function(set_LIBRARY_UTIL_Intel)
    ...
    set (IP_Fortran_FLAGS " -O2 -ip -fp-model strict -assume byterecl -convert big_endian -fpp -i${intsize} -r8 -convert big_endian -assume byterecl -DLINUX  ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    set (IP_Fortran_4_FLAGS " -O2 -ip -fp-model strict -assume byterecl -convert big_endian -fpp -convert big_endian -assume byterecl -DLINUX  ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    set (IP_F77_FLAGS " -DLINUX -O2 -ip -fp-model strict -assume byterecl -convert big_endian -fpp -i${intsize} -r8 -convert big_endian -assume byterecl -DLINUX ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
...
function(set_LIBRARY_UTIL_Debug_Intel)
    ...
    set(IP_Fortran_FLAGS " -g -ip -fp-model strict -assume byterecl -fpp -i${intsize} -r8 -convert big_endian  -DLINUX  ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    set(IP_Fortran_4_FLAGS " -g -ip -fp-model strict -assume byterecl -fpp -convert big_endian  -DLINUX  ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    set(IP_F77_FLAGS " -g -ip -fp-model strict -assume byterecl -convert big_endian -fpp -i${intsize} -r8 -DLINUX ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
...
function(set_GSI_ENKF_Intel)
    ...
    set(GSI_CFLAGS "-g -traceback -I. -DFortranByte=char -DFortranInt=int -DFortranLlong='long long'  -O3  -Dfunder" CACHE INTERNAL "" )
