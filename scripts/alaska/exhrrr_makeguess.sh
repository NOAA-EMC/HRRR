...
export FORMAT=rap.t${cycm1}z.awp242bgrbf00df
export SOURCE=RAP
...
if [ ! -r ${COMRAP}/rap.${PDY1}/rap.t${cycm1}z.awp242bgrbf00df ]; then
 if [ -r ${COMRAP}/rap.${PDY2}/rap.t${cycm2}z.awp242bgrbf01.grib2 ]; then
   export FORMAT=rap.t${cycm2}z.awp242bgrbf01.grib2
   export SOURCE_PATH=${COMRAP}/rap.${PDY2}
 elif [ -r ${COMRAP}/rap.${PDY3}/rap.t${cycm3}z.awp242bgrbf02.grib2 ]; then
   export FORMAT=rap.t${cycm3}z.awp242bgrbf02.grib2
   export SOURCE_PATH=${COMRAP}/rap.${PDY3}
 elif [ -r ${COMRAP}/rap.${PDY4}/rap.t${cycm4}z.awp242bgrbf03.grib2 ]; then
   export FORMAT=rap.t${cycm4}z.awp242bgrbf03.grib2
...
cp wrfinput_d01 $COMOUT/hrrrak.t${cyc}z.wrfguess_rap
cp rsl.out.0000 ${COMOUT}/hrrrak.t${cyc}z.rslguessout
