...
do
  ...
  do
    ...
    then 
#      qsub ${HOMEhrrr}/sms/post/post/jhrrr_post_f${fhr}_${cyc}.qsub
#      qsub ${HOMEhrrr}/sms/post/wrfbufr/jhrrr_wrfbufr_f${fhr}_${cyc}.qsub
...
#    can know the status of the previous hour's forecast job
  ...
  if [ $icnt -ge 780 ]
  then
    msg="FATAL ERROR: ABORTING after 130 minutes of waiting for HRRR FCST hours $postjobs."
    err_exit $msg
  fi
