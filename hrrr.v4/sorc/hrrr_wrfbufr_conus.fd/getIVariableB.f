subroutine getIVariableB(fileName,DateStr,dh,VarName,VarBuff,IM,JSTA_2L,JEND_2U,LM,IM1,JS,JE,LM1)
...
!       NETCDF
 ...
 ! the portion of VarBuff that is needed for this task.
   ...
   integer :: VarBuff(IM,JSTA_2L:JEND_2U,LM)
   integer :: ndim,IM,LM,JSTA_2L,JEND_2U
   integer :: IM1,LM1,JS,JE
   integer :: WrfType,i,j,l,ll
   integer, dimension(4) :: start_index, end_index
   character (len= 4) :: staggering
   character (len= 3) :: ordering
   character (len=90), dimension(3) :: dimnames
