...
!	print *, "JCAP ----------------==EM==---3------", JCAP
!        print *, "IDRT ----------------==EM==---3------", IDRT
!        print *, "LONB ----------------==EM==---3------", LONB
!        print *, "LATB ----------------==EM==---3------", LATB
!	print *, "KM,1,1,LONB2,LONB2,NC,IJN",KM,1,1,LONB2,LONB2,NC,IJN
!	print *," J1,J2,JC,ST,T(IN,1),T(IS,1),1", J1,J2,JC,ST,T(IN,1),T(IS,1) 
