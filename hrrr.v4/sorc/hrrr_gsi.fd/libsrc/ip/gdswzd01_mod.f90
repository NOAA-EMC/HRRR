...
!
! MODULE:  GDSWZD01_MOD  GDS WIZARD MODULE FOR MERCATOR CYLINDRICAL GRIDS
...
!
! USAGE:  "USE GDSWZD01_MOD"  THEN CALL THE PUBLIC DRIVER
!         ROUTINE "GDSWZD01".
!
! ATTRIBUTES:
!   LANGUAGE: FORTRAN 90
   ...
   IF(IOPT.EQ.0.OR.IOPT.EQ.1) THEN
     DO N=1,NPTS
       IF(XPTS(N).GE.XMIN.AND.XPTS(N).LE.XMAX.AND. &
         ...
         IF(LMAP)  CALL GDSWZD01_MAP_JACOB(RLAT(N),XLON(N),XLAT(N),YLON(N),YLAT(N))
         IF(LAREA) CALL GDSWZD01_GRID_AREA(RLAT(N),AREA(N))
       ELSE
         RLON(N)=FILL
         RLAT(N)=FILL
       ENDIF
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!
! SUBPROGRAM:  GDSWZD01_VECT_ROT   VECTOR ROTATION FIELDS FOR
...
!
! USAGE:    CALL GDSWZD01_VECT_ROT(CROT,SROT)
!
!   INPUT ARGUMENT LIST:
!     NONE
!
...
!
 SUBROUTINE GDSWZD01_MAP_JACOB(RLAT,XLON,XLAT,YLON,YLAT)
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!
! SUBPROGRAM:  GDSWZD01_MAP_JACOB  MAP JACOBIANS FOR
!                                  MERCATOR CYLINDRICAL GRIDS
!
!   PRGMMR: GAYNO     ORG: W/NMC23       DATE: 2015-01-21
!
...
! 2015-01-21  GAYNO    INITIAL VERSION
!
! USAGE:  CALL GDSWZD01_MAP_JACOB(RLAT,XLON,XLAT,YLON,YLAT)
!
!   INPUT ARGUMENT LIST:
...
!
 SUBROUTINE GDSWZD01_GRID_AREA(RLAT,AREA)
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!
! SUBPROGRAM:  GDSWZD01_GRID_AREA  GRID BOX AREA FOR
!                                  MERCATOR CYLINDRICAL GRIDS
!
!   PRGMMR: GAYNO     ORG: W/NMC23       DATE: 2015-01-21
!
...
! 2015-01-21  GAYNO    INITIAL VERSION
!
! USAGE:  CALL GDSWZD01_GRID_AREA(RLAT,AREA)
!
!   INPUT ARGUMENT LIST:
