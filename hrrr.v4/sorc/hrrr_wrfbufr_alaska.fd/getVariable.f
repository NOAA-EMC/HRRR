...
!       NETCDF
 ...
 ! the portion of VarBuff that is needed for this task.
   ...
   real :: VarBuff(IM,JSTA_2L:JEND_2U,LM)
...
! CHANGE WrfType to WRF_REAL BECAUSE THIS TELLS WRF IO API TO CONVERT TO REAL
 ...
 27 continue
    ...
    kk=min(lm1,end_index(3))
    do l=1,kk
     ll=kk-l+1  ! flip the z axis not sure about soil
     do i=1,min(im1,end_index(1))
      do j=js,min(je,end_index(2))
