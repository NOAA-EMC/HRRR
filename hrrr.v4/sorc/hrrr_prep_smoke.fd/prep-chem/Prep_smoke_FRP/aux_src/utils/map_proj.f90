...
!
! *****Subroutine to convert lat/lon pair to real i,j pair on Lambert
!onformal Conic grid***********
!
...
parameter (radearth=6370000) ! (USGS Paper 1395)
...
subroutine trueps60_ps (n1,n2,np1,np2,n3,nvar,ipos,aps,all,glat,glon  &
                       ,xswlat,xswlon,gdatdx,gdatdy,cntlat,cntlon,stdlat2)
implicit none
integer :: n1,n2,np1,np2,n3,nvar,ipos
real :: xswlat,xswlon,gdatdx,gdatdy,cntlat,cntlon,stdlat2
real :: aps(n1,n2,n3,*),all(np1,np2,n3,*),glon(n1,n2),glat(n1,n2)
...
!  call ll_xy(xswlat,xswlon,cntlat,cntlon,stdlat2,xw,ys)
...
!
!  call xy_ll(xnwlat,xnwlon,cntlat,cntlon,stdlat2,xw,yn)
!  call xy_ll(xselat,xselon,cntlat,cntlon,stdlat2,xe,ys)
...
real :: h,dx1,reflon,radpd,rebydx,ala1,alo1,polei,polej,ala,rm,alo,dxl,rmll
...
subroutine ps_ps (n1,n2,np1,np2,n3,nvar,aps,all,glat,glon  &
                 ,polelat,polelon,ppolelat,ppolelon,gglat1,gglon1,ddx,ddy,stdlat2)
implicit none
integer :: n1,n2,np1,np2,n3,nvar
real :: polelat,polelon,ppolelat,ppolelon,gglat1,gglon1,ddx,ddy,stdlat2
real :: aps(n1,n2,n3,*),all(np1,np2,n3,*),glon(n1,n2),glat(n1,n2)
...
call ll_xy(gglat1,gglon1,ppolelat,ppolelon,stdlat2,xxi,xxj)

do i=1,n1
   do j=1,n2

      ! RAMS lat/lon coordinates on the incoming polar stereo coord
      call ll_xy(glat(i,j),glon(i,j),ppolelat,ppolelon,stdlat2,xi,xj)
      ri = 1. + (xi - xxi) / ddx
      rj = 1. + (xj - xxj) / ddy
