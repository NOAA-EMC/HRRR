...
/
 ...
 nproc_x                             = %nproc_x% ! automatically replaced by run_wrf.sh
 nproc_y                             = %nproc_y% ! automatically replaced by run_wrf.sh
 numtiles                            = %numtiles% ! automatically replaced by run_wrf.sh
 /
 ...
 &namelist_quilt
 ! Script will add poll_servers=.true. here
 nio_tasks_per_group = %nio_tasks_per_group%, ! automatically replaced by run_wrf.sh
 nio_groups = %nio_groups%, ! automatically replaced by run_wrf.sh
 /
