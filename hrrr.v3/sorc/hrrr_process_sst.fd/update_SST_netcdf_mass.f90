...
!
  ...
  write(6,*)' max,min bck laked (K)=',maxval(laked),minval(laked)
       write(6,*)'background sst(170,170)', laked(170,170)
       write(6,*)'new  sstRR(170,170)', sstRR(170,170)
!
  write(6,*) '================================================='
  rmse_var='LU_INDEX'
...
!     endif  ! lakes correction
       ...
       if(vegtyp(i,j)==ilake .or. laked(i,j) .ne. 10.) then ! the fill value for lake depth is 10.
...
!update skin temp
  ...
  write(*,*) 'Skin temperature updated with current SST'
       ...
       write(6,*)'updated sst(170,170)', sst(170,170)
endif
!
!
