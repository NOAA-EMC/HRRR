...
!trunk            IF (IBOT>0 .AND. IBOT<=NINT(LMH(I,J))) THEN
!trunk              CLDP(I,J) = PMID(I,J,IBOT)
!trunk              CLDZ(I,J) = ZMID(I,J,IBOT)
!trunk            ELSE
!trunk              IF(MODELNAME == 'RAPR') then
!trunk                CLDP(I,J) = SPVAL
!trunk                CLDZ(I,J) = SPVAL
!trunk              ELSE
!trunk                CLDP(I,J) = -50000.
!trunk                CLDZ(I,J) = -5000.
!trunk              ENDIF
!trunk            ENDIF       !--- End IF (IBOT .LE. 0) ...
!RAPHRRR
            IF (IBOT .LE. 0) THEN
              IF(MODELNAME == 'RAPR') then
                CLDP(I,J) = SPVAL
