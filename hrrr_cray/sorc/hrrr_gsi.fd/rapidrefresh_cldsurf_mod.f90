...
!                         analysis.
!
!      if_check_high_dp  - namelist logical for moisture QC to toss the surface 
!                          observations which dewpoint is lager than 90 F.
!                         =false: don't do this QC (default)
!                         =true : turn on this QC
!
! attributes:
!   language: f90
