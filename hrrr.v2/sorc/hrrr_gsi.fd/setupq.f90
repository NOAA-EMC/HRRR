...
!
     if( if_check_high_dp .and. (itype > 179 .and. itype < 190)) then
       ...
       dwpt = (dwpt-273.15_r_single)*9.0_r_single/5.0_r_single+32.0_r_single   ! F
       if(muse(i) .and. dwpt > 90.0_r_single) then
           muse(i)=.false.
